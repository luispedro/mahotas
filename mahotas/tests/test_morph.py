...
def test_get_structuring_elem_dim3():
    get_structuring_elem(np.zeros((3,3,3), dtype=np.bool_), None)

@raises(ValueError)
def test_get_structuring_bad_Bc_spec():
    get_structuring_elem(np.zeros((8,8), dtype=np.bool_), 1)
